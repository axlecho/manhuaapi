...
@Parcelize
data class MHComicInfo(val title: String, val cover: String, val update: String, val intro: String, val author: String, val status: Boolean, val chapters: ArrayList<MHComicChapter>) : Parcelable
