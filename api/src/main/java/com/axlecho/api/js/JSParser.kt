...
class JSParser {
    companion object {
        private val Tag: String = JSParser::javaClass.name
        ...
        fun parserInfo(html: String): MHComicDetail {
            ...
            val into = body.text("div.book-cont > div.book-detail > div.book-intro > div#intro-all")
                    ?: ""
            val chapterCount = body.text("div.book-cont > div.book-detail > ul.detail-list > li.status > span > a")?.filterDigital()?.toIntOrNull()
                    ?: 0
            val favoriteCount = 0
        ...
        fun parserComment(html: String, currentPage: Int): MHMutiItemResult<MHComicComment> {
            ...
            return MHMutiItemResult(datas, 0, currentPage)
        }
    }
}
